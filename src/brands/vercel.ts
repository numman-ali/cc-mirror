...
const theme: Theme = {
  ...
  colors: {
    ...
    claudeBlue_FOR_SYSTEM_SPINNER: rgb(palette.ink),
    claudeBlueShimmer_FOR_SYSTEM_SPINNER: lighten(palette.inkSoft, 0.3),
    permission: rgb(palette.blue),
    permissionShimmer: lighten(palette.blue, 0.2),
    planMode: rgb(palette.inkSoft),
    ide: rgb(palette.greenSoft),
    ...
    suggestion: rgb(palette.greenSoft),
    ...
    cyan_FOR_SUBAGENTS_ONLY: rgb(palette.greenSoft),
