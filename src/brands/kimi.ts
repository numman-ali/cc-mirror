...
// Kimi Code: dark base with teal/cyan accents.
const palette = {
  base: '#0c1520',
  surface: '#111d2b',
  panel: '#142231',
...
const theme: Theme = {
  ...
  colors: {
    ...
    userMessageBackground: mix('#383838', palette.teal, 0.12),
    bashMessageBackgroundColor: mix('#404040', palette.teal, 0.08),
    memoryBackgroundColor: mix('#383838', palette.aqua, 0.1),
