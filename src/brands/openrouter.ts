...
// OpenRouter Chrome palette: silver/chrome with electric blue accents
// Ported from Mirror Claude theme — polished mirror surface aesthetic
const palette = {
